...
import com.android.countries.BuildConfig
...
import com.paypay.riyas.util.NetworkManager.isOnline
import com.paypay.riyas.util.TAG
import com.paypay.riyas.util.Utils.handleApiError
import com.paypay.riyas.util.Utils.handleSuccess
import com.paypay.riyas.util.noNetworkConnectivityError
...
class DataRepositoryImpl(
    ...
    val api: CurrencyLayerApi by inject()
        ...
        return try {
            ...
            if (response.isSuccessful) {
                ...
                return when (val result = handleSuccess(response)) {
                    is AppResult.Success -> {
                        val data =
                            getSupportedCurrenciesList(response.body()?.supportedCurrenciesMap)
